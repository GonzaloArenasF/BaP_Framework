/**
 * Tests para src/pages/cdn/index.js
...
describe('pages/cdn/index.js', () => {
  ...
  it('PAG-CDN-01: Inicializa sesión, componentes, internacionalización y telemetría al cargar', async () => {
    await import('../../src/pages/cdn/index.js');
    ...
    expect(analytics.analytic.logEvent.enterCdnPage).toHaveBeenCalledTimes(1);
  });
});
