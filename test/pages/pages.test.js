/**
 * Tests para src/pages/pages/index.js
...
describe('pages/pages/index.js', () => {
  ...
  it('PAG-PAG-01: Inicializa sesión, componentes, internacionalización y telemetría al cargar', async () => {
    await import('../../src/pages/pages/index.js');
    ...
    expect(analytics.analytic.logEvent.enterPagesPage).toHaveBeenCalledTimes(1);
  });
});
