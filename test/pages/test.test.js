/**
 * Tests para src/pages/test/index.js
...
describe('pages/test/index.js', () => {
  ...
  it('PAG-TST-01: Inicializa sesión, componentes, internacionalización y telemetría al cargar', async () => {
    await import('../../src/pages/test/index.js');
    ...
    expect(analytics.analytic.logEvent.enterTestPage).toHaveBeenCalledTimes(1);
  });
});
