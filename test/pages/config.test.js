/**
 * Tests para src/pages/config/index.js
...
describe('pages/config/index.js', () => {
  ...
  it('PAG-CFG-01: Inicializa sesión, componentes, internacionalización y telemetría al cargar', async () => {
    await import('../../src/pages/config/index.js');
    ...
    expect(analytics.analytic.logEvent.enterConfigPage).toHaveBeenCalledTimes(1);
  });
});
