/**
 * Tests para src/pages/style/index.js
...
describe('pages/style/index.js', () => {
  ...
  it('PAG-STY-01: Inicializa sesión, componentes, internacionalización y telemetría al cargar', async () => {
    await import('../../src/pages/style/index.js');
    ...
    expect(analytics.analytic.logEvent.enterStylePage).toHaveBeenCalledTimes(1);
  });
});
