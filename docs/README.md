...
- [./docs/security-audits/security-audit-v2.3.7.md](./docs/security-audits/security-audit-v2.3.7.md): Reporte de auditoría detallando vulnerabilidades (ej. XSS en componentes, validaciones faltantes) identificadas en el framework.
- [./docs/security-audits/security-fixes-v2.3.7.md](./docs/security-audits/security-fixes-v2.3.7.md): Bitácora de correcciones técnicas y mitigaciones implementadas en el core para la v2.3.9.
...
- **Suite de Pruebas**: El plan detallado en [./docs/upgrades/unit-test-plan.md](./docs/upgrades/unit-test-plan.md) se ejecuta físicamente a través de la suite ubicada en el directorio [./test/](./test/README.md).
