      ...
      body: {
        ...
        core: {
          ...
          security: {
            ...
            xss: "Inmunidad a inyecciones XSS mediante creación programática del DOM y sanitización avanzada de HTML con DOMPurify.",
  ...
  "rules": {
    ...
    pages: {
      ...
      body: {
        ...
        skillsTitle: "🤖 Desarrollo Asistido con Skills de IA",
        skillsDesc: "BaP Framework incluye un ecosistema de Habilidades e Instrucciones ejecutables para asistentes de IA ubicadas en el directorio <code>.agents/skills/</code>. Estas habilidades automatizan las tareas clave cumpliendo estrictamente con la arquitectura del framework:",
